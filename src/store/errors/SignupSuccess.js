...
/* states */
import { signupSuccessDefault } from "../states/app_state";
		...
		>
			...
			>
				<motion.circle
					...
					animate={signupSuccess ? { strokeDashoffset: 0 } : { strokeDasharray: 75.4, strokeDashoffset: 75.4 }}
				...
				<motion.path
					...
					animate={signupSuccess ? { strokeDashoffset: 0 } : { strokeDasharray: 25, strokeDashoffset: 25 }}
			...
			<motion.div
				...
				animate={signupSuccess ? { opacity: 1, y: 0 } : { opacity: 0, y: -10 }}
			...
			<motion.div
				...
				initial={{ opacity: 0 }}
				animate={signupSuccess ? { opacity: 1 } : { opacity: 0 }}
